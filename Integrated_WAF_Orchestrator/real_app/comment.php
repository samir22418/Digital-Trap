...
<head>
    ...
    <title>Comment - Digital Trap</title>
    <style>
        body {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['comment'])) {
    ...
    // VULNERABLE: Direct echo - XSS possible (no htmlspecialchars)
    echo "<div class='output'>";
    echo "<h3>Your Comment:</h3>";
    echo "<p>" . $comment . "</p>";  // XSS here!
    echo "</div>";
} else {
    echo "<div class='output'><p>No comment posted.</p></div>";
}
?>
